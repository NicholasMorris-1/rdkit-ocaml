...
# CTest Start Step
set(CTEST_SOURCE_DIRECTORY "/home/nick/rdkit-ocaml/vendor/rdkit")
set(CTEST_BINARY_DIRECTORY "/home/nick/rdkit-ocaml/build/rdkit")
...
# CTest Coverage Step
set(CTEST_COVERAGE_COMMAND "/nix/store/lvwga6ivl1d4lnw0zis9ajs0rqx9gp4i-gcc-15.2.0/bin/gcov")
set(CTEST_COVERAGE_EXTRA_FLAGS "-l")

# CTest MemCheck Step
set(CTEST_MEMORYCHECK_COMMAND "MEMORYCHECK_COMMAND-NOTFOUND")
set(CTEST_MEMORYCHECK_COMMAND_OPTIONS "--tool=memcheck --error-exitcode=13 --time-stamp=yes --num-callers=20 --gen-suppressions=all --leak-check=full --show-reachable=no --trace-children=yes --suppressions=/home/nick/rdkit-ocaml/vendor/rdkit/Code/cmake/rdkit_valgrind.suppressions")
set(CTEST_MEMORYCHECK_TYPE "")
set(CTEST_MEMORYCHECK_SANITIZER_OPTIONS "")
set(CTEST_MEMORYCHECK_SUPPRESSIONS_FILE "")

# CTest Submit Step
set(CTEST_SITE "Nick-Laptop")
